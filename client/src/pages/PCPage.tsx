...
export function PCPage({ username, onLogout, subscription, trialDaysLeft }: PCPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      {/* Header */}
      <header className="sticky top-0 z-10 flex items-center justify-between px-6 py-3.5 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <a
            href="/history"
            className="text-xs font-medium text-gray-500 bg-gray-100 hover:bg-gray-200 rounded-lg px-3 py-1.5 transition-colors"
          >
            履歴
          </a>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center gap-5 p-6">
        ...
        {/* Video area */}
        <div className="relative w-full max-w-2xl aspect-video bg-gray-900 rounded-2xl overflow-hidden shadow-2xl shadow-gray-900/20 ring-1 ring-gray-900/5">
          {isStreamReady ? (
            <>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              {localCamera.error ? (
                <div className="text-center text-red-300 px-6">
        ...
        {/* Controls card */}
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-5 flex flex-col items-center gap-4">
          {/* Overlay controls */}
          {isStreamReady && overlayUrl && (
            <div className="flex items-center gap-4 text-sm text-gray-600 w-full pb-4 border-b border-gray-100">
