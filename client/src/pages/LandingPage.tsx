  ...
  return (
    <div className="min-h-screen bg-[#F8FAF8] flex flex-col items-center justify-center px-6 py-4 lg:py-3 relative overflow-hidden" style={{ fontFamily: "'Kosugi Maru', sans-serif" }}>
      ...
      <div className="relative z-10 w-full max-w-4xl animate-fade-in-up">
        ...
        {/* 6 features grid - 3 cols x 2 rows */}
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5 mb-4">
          {[
            ...
            <div key={s.title} className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3.5 flex items-start gap-2.5">
        ...
        {/* === OLD LAYOUT (kept for rollback) ===
        <div className="grid lg:grid-cols-2 gap-3 lg:gap-4 mb-3">
        ...
        {/* Steps */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-2.5 mb-4">
